...
namespace ProjectDawn.Navigation.Hybrid.Editor
{
    ...
    class AgentNavMeshEditor : UnityEditor.Editor
    {
        static class Styles
        {
            ...
            public static readonly GUIContent Constrained = EditorGUIUtility.TrTextContent("Constrained", "Constraint agent to be on the surface. It is useful to disable then used with physics, to allow more freedom motion and precision.");
        ...
        SerializedProperty m_Constrained;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_Constrained, Styles.Constrained);
        ...
        void OnEnable()
        {
            ...
            m_Constrained = serializedObject.FindProperty("m_Constrained");
